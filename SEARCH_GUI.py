...
class Ui_root(object):
    ...
    def greedyMethod(self):
        ...
        a, b, c, d = Greedy.Greedy(getGraph.dict_graph, self.city1.currentText(), self.city2.currentText())
        ttt = (b / int(self.KMforL.toPlainText())) * 2.18
        for i in getGraph.dict_graph:
            color = 'blue'
            for k in a:
                if i == k:
                    color = 'green'
        ...
        for i in getGraph.dict_graph:
            for j in getGraph.dict_graph[i]:
                pyvis_graph.add_edge(i, j, label=getGraph.dict_graph[i].get(j), title=getGraph.dict_graph[i].get(j))
    ...
    def aStarMethod(self):
        ...
        a, b, c, d = Astar.astar(getGraph.dict_graph, self.city1.currentText(), self.city2.currentText())
        ttt = (b / int(self.KMforL.toPlainText())) * 2.18
        for i in getGraph.dict_graph:
            color = 'blue'
            for k in a:
