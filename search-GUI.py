...
class Ui_root(object):
    def setupUi(self, root):
        ...
        self.label_2.setGeometry(QtCore.QRect(370, 60, 101, 41))
        ...
        self.widget.setGeometry(QtCore.QRect(-1, 310, 1391, 591))
        font = QtGui.QFont()
        font.setPointSize(22)
    ...
    def retranslateUi(self, root):
        ...
        #     for k in f:
        #         counter = counter + 1
        #         self.city1.setItemText(counter, _translate("root", k))
        #         self.city2.setItemText(counter, _translate("root", k))
        ...
        # self.aSTAR.clicked.connect(lambda: print(self.city1.currentText().istitle()))
